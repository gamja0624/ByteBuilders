...
public class AdminController {
	...
	public String diarySearch(@RequestParam("diary") String diary_title, Model model) {
		model.addAttribute("DiaryList", diaryRepository.findByTitleDiary(diary_title));
		return "admin/diary/diarySearchResults";
	}

	// 노태윤
	// 일기 삭제 기능 추가
	@PostMapping("/diaryDelete/{diary_id}")
	public String deleteDiary(@PathVariable("diary_id") int diary_id, @SessionAttribute("admin_key") String admin_key) {
